...
const RESET_PLAN: readonly PlanEntry[] = [
  ...
  },
  {
    ...
    order: 30.66,
    label: 'Items',
    why: 'The catalogue. References units, tax codes and accounts, so it goes before them — and AFTER bill and invoice lines, which name an item under a RESTRICT key.',
  },
  {
    table: 'warehouses',
    action: 'scoped_delete',
    order: 30.68,
    label: 'Warehouses',
    why: 'Deleted after the settings row that may point at one, and after the bill and invoice lines that name one under a RESTRICT key.',
  },
  {
  ...
  },
  {
    ...
    why: 'The tenant counterparty directory. Meaningless once the tenant is gone. Deleted AFTER the bills and invoices that name a party, which hold it under a RESTRICT key.',
  },
  {
