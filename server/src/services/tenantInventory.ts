...
export const TENANT_DEPENDENCIES: readonly TenantDependency[] = [
  ...
  },
  {
    ...
    label: 'Items',
    crossTenantReachable: false,
    rationale: 'The product and service catalogue. References units, tax codes and accounts, so it is deleted before them.',
  },
  {
    table: 'warehouses',
    ownershipKey: 'organization_id',
    ...
    label: 'Warehouses',
    crossTenantReachable: false,
    rationale: 'Where stock will be held. Deleted after the settings row that may point at one.',
  },
  {
  ...
  },
  {
    ...
    crossTenantReachable: false,
    rationale: 'The tenant counterparty directory: customers today, suppliers when Purchasing migrates.',
  },
  {
