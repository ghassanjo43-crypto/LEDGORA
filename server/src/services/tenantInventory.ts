...
export const TENANT_DEPENDENCIES: readonly TenantDependency[] = [
  ...
  },
  {
    ...
    label: 'Counted lines',
    crossTenantReachable: false,
    rationale: 'What was found on a shelf. References items and units under RESTRICT keys, so it goes before them, and before the count that owns it.',
  },
  {
    table: 'stock_counts',
    ownershipKey: 'organization_id',
    ...
    label: 'Stock counts',
    crossTenantReachable: false,
    rationale: 'A physical count and the adjustment it settled. Deleted before the stock documents and warehouses it points at.',
  },
  {
    ...
    crossTenantReachable: false,
    rationale: 'The counter behind count numbers; meaningless once the counts are gone.',
  },
  {
